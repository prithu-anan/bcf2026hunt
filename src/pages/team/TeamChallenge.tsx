...
export default function TeamChallenge() {
  ...
  if (isComplete) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-md">You've completed all challenges! Check the leaderboard to see your final ranking.</p>
      </div>
    );
  }

  if (!currentLevel) {
    return <div className="flex items-center justify-center min-h-[40vh]"><div className="animate-pulse">Loading challenge...</div></div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {currentLevel.image && <ChallengeViewer image={currentLevel.image} title="Challenge Image" />}
      {currentLevel.attachment && <PDFViewer url={currentLevel.attachment} title="Challenge Attachment" />}
